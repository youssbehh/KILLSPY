...
const AudioParam = ({ title, children }) => {
...
const AudioContainer = () => {
    ...
    return (<View>
            <AudioParam title={motTraduit(langIndex, 19)}>
                ...
                <Slider value={bgmVolume} onValueChange={handleBgmSliderChange} minimumValue={0} maximumValue={10} step={1} allowTouchTrack minimumTrackTintColor="#007AFF" maximumTrackTintColor="#DDDDDD" thumbTintColor="#007AFF" style={styles.slider} thumbProps={{
            children: (<View style={styles.thumbContainer}>
                                <FontAwesomeWrapper icon={getVolumeIcon(bgmVolume)} color="black"/>
                            </View>),
        }}/>
                <View style={styles.volumeContainer}>
                ...
                <Slider value={sfxVolume} onValueChange={handleSfxSliderChange} minimumValue={0} maximumValue={10} step={1} allowTouchTrack minimumTrackTintColor="#007AFF" maximumTrackTintColor="#DDDDDD" thumbTintColor="#007AFF" style={styles.slider} thumbProps={{
            children: (<View style={styles.thumbContainer}>
                                <FontAwesomeWrapper icon={getVolumeIcon(sfxVolume)} color="black"/>
                            </View>),
        }}/>
            </AudioParam>
        </View>);
