...
export default function QuitButton({ redirectPath = '/(tabs)' }) {
    const { langIndex } = useLanguageStore();
    const handleQuit = () => {
        Alert.alert(motTraduit(langIndex, 44), // "Quitter la partie ?"
    ...
    return (<Pressable onPress={handleQuit} style={({ pressed }) => [
            styles.quitButton,
